...
(async () => {
  // 345 KB, not 140: the Books tab and the reader added about seven, putting a
  ...
  ok('the shell is small', shipped < 345000, Math.round(shipped / 1024) + ' KB');
